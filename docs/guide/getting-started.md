...
3. 将 VuePress 安装为本地依赖
   ...
   ::: warning 注意
   如果你的现有项目依赖了 webpack 3.x，我们推荐使用 [Yarn](https:/classic.yarnpkg.com/-Hans/) 而不是 npm 来安装 VuePress。因为在这种情形下，npm 会生成错误的依赖树。
   :::
...
5. 在 `package.json` 中添加一些 [scripts](https:/classic.yarnpkg.com/-Hans/docs/package-json#toc-scripts)
